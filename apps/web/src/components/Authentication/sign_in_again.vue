    ...
    <v-dialog v-model="dialog" width="500">
      <v-card>
        <v-card-title class="headline red white--text" dark
                      primary-title> Session Expired
        </v-card-title>
        <v-card-text>Your session has expired. Please sign in again.</v-card-text>
        <v-divider></v-divider>
        <v-card-actions>
          <v-spacer></v-spacer>
                ...
                <v-card-actions class="justify-center">
                  ...
                  <v-dialog v-model="failedLoginDialog" width="400">
                    <v-card>
                      ...
                      <v-card-text>Failed to sign in. please try again.</v-card-text>
                      <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="black" text type="button"
                  ...
                  <v-dialog v-model="forogtPasswordDialog" width="400">
                    ...
                    <v-card>
                      <form ref="resetPasswordForm"
                        ...
                        <v-card-text>Please write your email and click reset password</v-card-text>
                        <v-card-text>Check your junk mail if you have not received</v-card-text>
                        <v-card-text>a confirmation in a few minutes</v-card-text>
                                ...
                                <div class="text-xs-center">
                                  <v-dialog v-model="passResetSuccessDialog" width="500">
                                    <v-card>
                                      ...
                                      <v-card-actions>
                                        <v-spacer></v-spacer>
                                        <v-btn color="red white--text" text
