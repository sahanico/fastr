...
export default {
  ...
  methods: {
    createDesign() {
      this.$router.push('/charts/designer');
    },
    readDesign(design) {
      this.$router.push({ name: 'ChartRead', params: { name: design.name, obj: design.object } });
    },
    updateDesign(design) {
      this.$router.push({ name: 'ChartDesigner', params: { design, path: 'charts-list', context: 'update' } });
    },
