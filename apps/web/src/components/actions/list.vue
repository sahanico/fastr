...
export default {
  ...
  methods: {
    createDesign() {
      this.$router.push('/actions/designer');
    },
    readDesign(design) {
      this.$router.push({ name: 'ActionRead', params: { name: design.name, obj: design.object } });
    },
    updateDesign(design) {
      this.$router.push({ name: 'updateActionDesign', params: { design, path: 'actions-list' } });
    },
