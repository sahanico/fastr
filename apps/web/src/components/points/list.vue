...
export default {
  ...
  methods: {
    createDesign() {
      this.$router.push({ name: 'PointDesigner', params: { path: 'points-list', context: 'create' } });
    },
    readDesign(design) {
      this.$router.push({ name: 'PointRead', params: { name: design.name, obj: design.object } });
    },
    updateDesign(design) {
      this.$router.push({ name: 'PointDesigner', params: { design, path: 'points-list', context: 'update' } });
    },
